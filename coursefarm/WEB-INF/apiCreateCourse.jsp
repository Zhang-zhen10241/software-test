...
<html lang="en">
	...
	<head>
		...
		<title>学而思网校-建课&购课一体化平台欢迎您！</title>
		...
		<div class="am-g tpl-g">
			...
			<div class="left-sidebar" id="sidebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-nav-link">
						<a href="http://10.170.151.17:2022/coursefarm/apiCreateCourseOnline">
					...
					<li class="sidebar-nav-link">
           			...
           			<li class="sidebar-nav-link">
           				<a href="" style="border-top-width: 20px;margin-top:20px;">
						   <i class="am-icon-wpforms sidebar-nav-link-logo"></i> 友情链接
					</a>
					</li>
					<!--<li class="sub-menu dcjq-parent-li" style="position:fixed;width:240px;bottom: 0px;solid #3A4144;text-indent:2em;margin-top:10px">
						<ul class="sub" style="display: block;">-->
					<li  style="solid #3A4144;text-indent:3em;margin-top:2px;">
						<a href="https://wiki.zhiyinlou.com/" target="_blank">学而思网校WIKI</a>
					</li>
							
					<li style="solid #3A4144;text-indent:3em;margin-top:2px;">
						<a href="http://mgqatool.xesv5.com:8888/ex/index.php" target="_blank">用例管理中心</a>
					</li>
					<li style="solid #3A4144;text-indent:3em;margin-top:2px;">
						<a href="http://qa.xesv5.com/" target="_blank">学而思网校EP</a>
					</li>
					<li style="solid #3A4144;text-indent:3em;margin-top:2px;">
						<a href="http://bh.xesv5.com/" target="_blank">白虎平台</a>
					</li>
					<li style="solid #3A4144;text-indent:3em;margin-top:2px;">
						<a href="http://10.170.152.234:6999/nezha_war_exploded/login.html" target="_blank">哪吒系统</a>
					</li>
					<li style="solid #3A4144;text-indent:3em;margin-top:2px;">
						<a href="http://10.170.151.17/shopping-cart.html" target="_blank">线上环境购课</a>
					</li>
					<li style="solid #3A4144;text-indent:3em;margin-top:2px;">
						<a href="http://10.170.152.234:2020/shopping-cart.html" target="_blank">测试环境购课</a>
					</li>
					<li style="solid #3A4144;text-indent:3em;margin-top:2px;">
						<a href="http://10.170.151.17/cc.html" target="_blank">灰度场次配置</a>
					</li>
							
					<li style="solid #3A4144;text-indent:3em;margin-top:2px;">
						<a href="http://monitor.arts.xesv5.com/" target="_blank">好未来监控系统</a>
					</li>
													
					<li style="solid #3A4144;text-indent:3em;margin-top:2px;">
						<a href="http://basiclog.xesv5.com/" target="_blank">Kibana平台</a>
					</li>
							
					<li style="solid #3A4144;text-indent:3em;margin-top:2px;">
						<a href="http://deploy.xesv5.com/" target="_blank">发布系统平台</a>
					</li>
					<li style="solid #3A4144;text-indent:3em;margin-top:2px;">
						<a href="http://mgqatool.xesv5.com:8888/cal/ex/view.html" target="_blank">学而思网校发版日历</a>
					</li>
				</ul>
			</div>
							...
							<div class="widget am-cf">
								...
								<div class="widget-body am-fr">
									...
									<form class="am-form tpl-form-line-form">
										...
										<div class="am-form-group">
											<label for="user-name" class="am-u-sm-3 am-form-label">随堂测ID
											
										</label>
											<div class="am-u-sm-9">
												<input type="text" class="tpl-form-input" id="classroomTestId"  value="" placeholder="非必填，课程需要插入的随堂测ID">
											</div>
										</div>
		...
		<script type="application/javascript">
			function createCourse() {
				...
				var course = {
					...
					classroomTestId: $("#classroomTestId").val().trim(),
